...
const CompromissosIcon: React.FC<{ color?: string }> = ({ color = INACTIVE_COLOR }) => (
  <Svg width="18" height="18" viewBox="0 0 64 64" fill="none">
    <Path d="M50.321 4H13.679A9.69 9.69 0 0 0 4 13.679v36.642A9.69 9.69 0 0 0 13.679 60h36.642A9.69 9.69 0 0 0 60 50.321V13.679A9.69 9.69 0 0 0 50.321 4zm-1.43 21.024L29.284 44.632a4 4 0 0 1-5.657 0l-8.518-8.518a4 4 0 1 1 5.657-5.656l5.69 5.689 16.778-16.779a4 4 0 1 1 5.657 5.656zm7.778 18.994a1 1 0 0 1-2 0v-3.777a1 1 0 0 1 2 0zm0-8.036a1 1 0 0 1-2 0v-2.33a1 1 0 0 1 2 0z" fill={color}/>
    <Path d="M44.648 20.782 27.163 38.268a1 1 0 0 1-1.414 0l-6.4-6.4a2 2 0 1 0-2.826 2.832l8.519 8.518a2.047 2.047 0 0 0 2.828 0L47.477 23.61a2 2 0 1 0-2.829-2.828z" fill={color}/>
  </Svg>
);

const ComercialIcon: React.FC<{ color?: string }> = ({ color = INACTIVE_COLOR }) => (
  <Svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <Path d="M22 20.875h-1V5.625c0-2.209-1-4-4-4H7c-3 0-4 1.791-4 4v15.25H2a.75.75 0 0 0 0 1.5h20a.75.75 0 0 0 0-1.5zm-12-4H7a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5zm0-4.5H7a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5zm0-4.5H7a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5zm7 9h-3a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5zm0-4.5h-3a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5zm0-4.5h-3a.75.75 0 0 1 0-1.5h3a.75.75 0 0 1 0 1.5z" fill={color}/>
  </Svg>
);
...
const SideMenuScreen: React.FC<SideMenuScreenProps> = ({ isVisible, onClose }) => {
  ...
  const menuItems = [
    ...
    { icon: <CarteiraIcon />, title: 'Carteira Digital', color: '#91929E' },
            ...
            return (
              <TouchableOpacity
                ...
                onPress={() => {
                  ...
                  if (item.title === 'Carteira Digital') {
                    navigation.navigate(ScreenNames.WalletHome);
                    onClose();
                  }
                }}
              >
